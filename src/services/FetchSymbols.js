...
const priceUrl = (symbol) => 'https://finnhub.io/api/v1/quote?symbol=' + symbol + '&token=' + process.env.REACT_APP_API_KEY;
...
const getLatestPrice = (symbol) => axios.get(priceUrl(symbol)).then(response => response.data.c);

export {getAllSymbols, getLatestPrice};